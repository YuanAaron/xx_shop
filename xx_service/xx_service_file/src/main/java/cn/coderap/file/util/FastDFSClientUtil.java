...
public class FastDFSClientUtil {
    ...
    /**
     * 文件上传
     * 返回：results[0]为group，results[1]为remoteFileName
     */
    public static String[] upload(FastDFSFile file) {
        ...
        try {
            ...
            e.printStackTrace();
            log.error("上传文件时发生异常:" + file.getName());
        }
        return results;
    }
    ...
    public static FileInfo getFileInfo(String group, String remoteFileName) {
        ...
        try {
            ...
            e.printStackTrace();
            log.error("获取文件信息时发生异常:" + group + "," + remoteFileName);
        }
        return info;
    }
    ...
    public static InputStream downFile(String group, String remoteFileName) {
        try {
            ...
            e.printStackTrace();
            log.error("下载文件时发生异常:"+group+","+remoteFileName);
            return null;
        }
    }
    ...
    public static void deleteFile(String group, String remoteFileName){
        try {
            ...
            e.printStackTrace();
            log.error("删除文件时发生异常:"+group+","+remoteFileName);
        }
    }
    ...
    /**
     * 获得存储组信息，即根据组名获取该组所有的StorageServer
     */
