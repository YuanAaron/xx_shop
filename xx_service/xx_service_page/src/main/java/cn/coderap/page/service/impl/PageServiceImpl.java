package cn.coderap.page.service.impl;

import cn.coderap.entity.Result;
import cn.coderap.goods.pojo.Sku;
import cn.coderap.goods.pojo.Spu;
import cn.coderap.page.feign.CategoryFeign;
import cn.coderap.page.feign.SkuFeign;
import cn.coderap.page.feign.SpuFeign;
...
public class PageServiceImpl implements PageService {
    ...
    private void loadGoodsInfo(String spuId, Map<String, Object> resultMap) {
        ...
        result = skuFeign.findList(paramMap);
        List<Sku> skuList = JSON.parseArray(JSON.toJSONString(result.getData()), Sku.class);
